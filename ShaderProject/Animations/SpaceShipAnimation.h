...
public:
	...
	SpaceShipAnimation(GameObject& spaceShip, GLfloat startTime) : PathAnimation(startTime), spaceShip(spaceShip) {
		...
		//dramatic slowdown
		animation.push_back(AnimationSequence(Bezier(glm::vec3(0, 0, -3840), glm::vec3(0, 0, -4400), glm::vec3(0, 0, -4800), glm::vec3(0, 0, -5000)), EaseTypes::EaseOutQuad, Bezier(glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), glm::vec3(0, 0, 0), glm::vec3(0, 0, 0)), EaseTypes::EaseOutQuad, 2.0f));
		//slow cruisin'
