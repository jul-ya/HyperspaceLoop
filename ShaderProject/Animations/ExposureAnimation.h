...
public:
	...
	ExposureAnimation(BloomPostProcessing& bloomPostProcess, GLfloat startTime) : PathAnimation(startTime), bloomPostProcess(bloomPostProcess) {
		...
		animation.push_back(AnimationSequence(/*path*/ Bezier(glm::vec3(1, 0, 0), glm::vec3(1, 0, 0), glm::vec3(1, 0, 0), glm::vec3(1, 0, 0)), /*ease*/ EaseTypes::EaseInOutQuad, /*rotation*/ Bezier(), /*ease and duration*/ EaseTypes::EaseInOutQuad, 22.0f));
		
		animation.push_back(AnimationSequence(Bezier(glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3(6.0f, 0.0f, 0.0f), glm::vec3(6.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.0f, 0.0f)), EaseTypes::EaseInOutQuad, Bezier(), EaseTypes::EaseInOutQuad, 7.0f));
